...
Dato che per noi lambda nuovo è maggiore di lambda vecchio quello è positivo...
so che s punta nella direzione massima di L quindi per trovare un lambda migliore partiamo dal vecchio lambda e facciamo un passo in quella direzione di lunghezza step

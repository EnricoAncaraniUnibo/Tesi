...
\begin{document}
	...
	\end{equation}
	(2.19)$\rightarrow$(2.21): Nel passaggio tra le equazioni sono stati svolte 2 semplici operazioni: un raccoglimento dei termini comuni e l'applicazione della proprietà associativa. \smallskip \\
	Dato che l'ultimo termine non ha variabili decisionali può essere estratto in quanto nella ricerca del minimo non porta differenza.
	\begin{equation}

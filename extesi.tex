...
\end{lstlisting}}
\subsubsection{Python API}
L'integrazione in linguaggio python tramite l'API di Cplex ha mantenuto le idee presentate nell'ambiente Cplex, definendo inizialmente le variabili e successivamente la funzione obiettivo e i vincoli.

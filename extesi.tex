...
\begin{enumerate}
	...
	\item Per $\lambda \geq 0$ e $Ax^* - b\geq 0$ si ha $cx^* \geq cx^* - \lambda(ax^*-b)$.
	...
	$$L(\lambda)=\min(cx-\lambda(Ax-b))\leq cx^*-\lambda(Ax^*-b)$$.\vspace{-0.75cm}
	\item Unendo le diseguaglianze: $z(P)=cx^* \geq cx^* - \lambda(ax^*-b)\geq L(\lambda)$
\end{enumerate}
%

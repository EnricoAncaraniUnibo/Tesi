...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\shortstack[c]{\textbf{Risultato Terza} \\ \textbf{Formulazione Lagrangiana}} &
		\shortstack[c]{\textbf{Breve} \\ \textbf{Descrizione}} \\ \hline
		1 & Target & 632 & Lower e Upper ottimi \\ \hline
		2 & Target & 796 & Lower e Upper ottimi \\ \hline
		3 & Target & 3596 & Lower e Upper ottimi\\ \hline
		4 & Informazioni & 6396 & Lower ottimo, gap=36, mA=40\\ \hline
		5 & Broker & 6396 & Lower e Upper ottimi\\ \hline
		6 & Archi &6396 & Lower e Upper ottimi\\ \hline
		7 & Informazioni & 9196 & Lower e Upper ottimi\\ \hline
...
\end{table} \newpage
\noindent I risultati raccolti nella tabella permettono di valutare vari aspetti del nostro algoritmo lagrangiano per la terza formulazione all'aumentare della complessità dello scenario. Nelle prime iterazioni, l'incremento dei target aumenta vertiginosamente il costo della rete, evidenziando come alcuni nodi aggiunti sono irraggiungibili, aumentando dunque della penalità $P$ moltiplicata per il numero delle richieste non soddisfatte, il costo della rete. Un comportamento simile si nota all'aggiunta di nuove informazioni da trasmettere, questo è dovuto o ai nuovi archi attivati per soddisfare la nuova richiesta o all'impossibilità di soddisfare tale richiesta. Al contrario di questi eventi, l'aumento della dimensione della rete non provoca mutazioni nel valore ottimo della rete, questo perché nella casualità un nodo o arco dovrebbe riuscire a creare un nuovo percorso ottimo per abbassare il costo della funzione obiettivo ma questo è altamente imporababile. Analizzando più nel dettaglio la convergenza si nota come nelle casistiche in cui l'Upper Bound non è riuscito a convergere, il Lower ha dimostrato sempre invece più convergenza e in molte casistiche la non convergenza dell'Upper era meno costosa di un errore di scelta su un arco rendendo quindi comunque ottimale lo scenario. Solo alla fine l'aggiunta di un broker ha complicato il calcolo dell'Upper Bound allontanandolo ancora di più dall'ottimo rendendo lo step per l'aggiornamento del Lower meno adatto e quindi impendendo il raggiungimento dell'ottimo.
Effettuato sto test nasce l'idea di effettuarne altri sulla base sia dell'aumento dei target e informazioni da un lato sia dei broker e archi dall'altro per vedere dove si trova la criticità maggiore.

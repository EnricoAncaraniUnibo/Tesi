...
\subsection{caso 3}
Il terzo scenario di test introduce una situazione di congestione della rete in cui tre informazioni, di cui una con due target, competono per arrivare ai nodi Subscriber. Le capacità sono state elaborate precisamente per cercare uno scenario di congestione prima della strada ottima poi dell'unica altra strada fattibile.
Gli obiettivi di questo scenario sono molteplici: La corretta saturazione della strada ottima, la corretta scelta della seconda strada fattibile e la corretta scelta di quale informazione non trasmettere.
\begin{figure}[h]
	\centering

...
La generazione degli scenari segue due modalità: una manuale per analizzare in modo mirato i casi limite e le potenziali criticità e una casuale per verificare la correttezza in contesti non preconfigurati.
...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c|c|}
		\hline
		\textbf{Algoritmo} & \textbf{Soluzione} & \textbf{Tempo Impiegato (secondi)} \\ \hline
		Prima Formulazione Cplex & 7 & / \\ \hline
		Prima Formulazione Python API & 7 & 0.0115 \\ \hline
		Seconda Formulazione Lagrangiana & 7 & 0.0173 \\ \hline
		Seconda Formulazione Cplex & 7 & / \\ \hline
		Seconda Formulazione Python API & 7 & 0.0580 \\ \hline
		Terza Fomrulazione Lagrangiana & 7 & 0.0120 \\ \hline
		Terza Fomrulazione Cplex & 7 & / \\ \hline
		Terza Fomrulazione Python API & 7 & 0.0481 \\ \hline
	\end{tabular}
	\caption{Panoramica degli scenari di test analizzati.}
	\label{tab:scenari_test}
\end{table}

\noindent Come si vede dai risultati, nonostante tra la prima e le altre due formulazione ci sia un metodo diverso di contaggio del costo di trasporto tutte hanno dato la stessa soluzione ottima con dei tempi molto rapidi.
...
NodiTarget= {0: [4]}
a= {0: 1}
C= {(0, 2): 1, (0, 1): 35, (0, 3): 27, (2, 3): 4, (1, 4): 74, (2, 4): 77, (3, 4): 2}
...
\subsection{caso 3}
Il terzo scenario di test introduce una situazione di congestione della rete in cui tre informazioni, di cui una con due target, competono per arrivare ai nodi Subscriber. Le capacità degli archi sono state elaborate precisamente per indurre uno scenario di saturazione che colpisca prima il percorso ottimo e poi l'unica altra via agibile.
Gli obiettivi di questo scenario consistono nel verificare la corretta saturazione della cammino ottimo, l'efficace scelta della seconda via percorribile e la selezione ottimale di quale informazione non trasmettere.
\begin{figure}[h]
	\centering
